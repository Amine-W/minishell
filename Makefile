...
#    Updated: 2025/11/10 13:37:17 by amwahab          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = srcs/main.c $(LEXER_SRCS) $(AST_SRCS) $(PARSER_SRCS) $(EXPAND_SRCS) $(EXEC_SRCS) $(HEREDOC_SRCS)
...
clean:
	rm -f $(OBJS) $(TEST_LEXER_OBJS) $(TEST_AST_OBJS) $(TEST_PARSER_OBJS) $(TEST_EXPAND_OBJS)
	make clean -C $(LIBFT_DIR)

fclean: clean
	rm -f $(NAME) $(TEST_LEXER) $(TEST_AST) $(TEST_PARSER) $(TEST_EXPAND)
	make fclean -C $(LIBFT_DIR)

re: fclean all

.PHONY: all test_lexer test_ast test_expand clean fclean re